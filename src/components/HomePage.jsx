      ...
      <div className="row">
        ...
        <div className="col  pt-5">
          <ul className="column-list">
            ...
            <li>Murasaki Aromatique Incense</li>
            <li>Kagerou Aromatique Incense</li>
            <li>Sarashina Aromatique Incense</li>
          </ul>
        </div>
        <div className="col">
          <img src={img} alt="Image" className="image w-100" />
        </div>
      </div>
    </div>
  );
